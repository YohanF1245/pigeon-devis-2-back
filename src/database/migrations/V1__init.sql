...
-- Création de la table password_reset_links
...
-- Création de la table businesses
...
-- Création de la table estimates
...
-- Trigger pour estimates
CREATE TRIGGER update_estimates_updated_at
    BEFORE UPDATE ON estimates
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

-- Création de la table estimate_lines
